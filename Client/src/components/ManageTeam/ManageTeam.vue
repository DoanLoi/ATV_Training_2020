<template>
  <div class="calendar">
    <div class="calendar__title">Quản lý Team</div>
     <button class="submit-button" @click="activeModal=!activeModal">Thêm Intern</button>
            ...
            <vs-row>
              <vs-col lg="5" sm="12" class="profile__basic">
                <ul class="profile__infor__company">
                  <li><h2 style="text-align: start">Leader: Cristiano Ronaldo</h2></li>
                  <li><h5>Lĩnh vực: Web fullstack</h5></li>
                  <li><h5>Employee ID : FT-0001</h5></li>
                  <li><h5>Date of Join : 1st Jan 2013</h5></li>
                </ul>
              </vs-col>
              <vs-col
                vs-type="flex"
              ...
              >
                <ul class="profile__detail">
                  <li>
                    ...
                    <div class="text">04248324324</div>
                  </li>
                  <li>
                    <div class="title">Email:</div>
                    <div class="text">đấ@dasdsa.com</div>
                  </li>
                  <li>
    ...
    <div class="calendar__title" style="font-size:20px">Danh sách Intern Of Team</div>
    <div class="calendar__content">
      ...
      <div class="edit-form">
        <input type="text" placeholder="Search by name or account" class="edit-input"
          @keyup="showResult='block'"
          @blur="onBlur()"
          v-model="keyword"
          />
